...
<ul>
	...
	<li>For each loaded box <strong>in order</strong>, theship wll make a <strong>trip</strong> to the port the box needs to be delivered to and deliver it. If the ship is already at the correct port, no <strong>trip< /stong> is needed, and  the box can immediately be delivered.</li>
